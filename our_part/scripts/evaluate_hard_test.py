...
from scripts.run_v1_experiments import (  # noqa: E402
    ENCODER_MODEL_NAMES,
    LABELS,
    LABEL_TO_INDEX,
    make_head,
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--hard-test-file",
        type=Path,
        default=ROOT / "data" / "hard_test" / "hard_test.csv",
    )
    parser.add_argument(
        "--artifact-dir",
        type=Path,
        default=ROOT / "reproduced" / "artifacts" / "v1",
    )
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=ROOT / "reproduced" / "hard_test",
    )
    parser.add_argument(
        "--combo-report-dir",
        type=Path,
