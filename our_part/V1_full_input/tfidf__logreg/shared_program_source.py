...
DEFAULT_OUTPUT_DIR = ROOT / "artifacts" / "ours"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--report-dir",
        type=Path,
        default=ROOT / "experiments" / "results" / "latest",
...
def main() -> None:
    ...
    write_json(
        args.output_dir / "experiment_plan.json",
        {
            ...
            "seed": args.seed,
            "artifact_layout": {
                "embedding_cache": "artifacts/ours/embeddings/{encoder}/",
                "run_output": "artifacts/ours/runs/{encoder}__{head}/",
                "summary": "artifacts/ours/summary.csv and summary.md",
            },
        },
    )
